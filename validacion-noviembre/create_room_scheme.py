...
- Validation sensor grid (7x9 = 63 points)
- Door location (on east wall)
- Orientation indicators

Output: images/room_scheme.png
"""
...
def create_room_scheme():
    ...
    ax.scatter(sensor_x, sensor_y, c='red', s=80, marker='o',
               ...
               label=f'Luxmeter positions ({NX}x{NY}={NX*NY})')
    ...
    ax.set_title('Room Scheme - Validation Sensor Grid\n'
                 f'Grid: {NX}x{NY} = {NX*NY} points | Spacing: {SPACING} m | Height: 0.75 m',
    ...
    output_path = 'images/room_scheme.png'
